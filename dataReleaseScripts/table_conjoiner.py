...
############################################################################
#### Aggregating function to pull ind. tables together for each lake-year
############################################################################
...
if __name__ == '__main__':
    ...
    # loop through all lake*years okay for a single category
    ...
    layk_idees = ["OWS19", "OWS20", "SEN18", "SEN19", "SKN19", "SEN20"] # project specific, don't need in main

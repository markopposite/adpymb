...
df_adcp <- readline((prompt="Enter raw data file:"))
# adp_id <- 'SEN19280'
adp_id <- readline((prompt = "Enter lake year file id:"))
# csv_dir <- "/home/mpoe/adcp_habs/data/adcp_data_tables/"   
csv_dir <- readline((prompt = "Enter dir for table storage: ")) 


# define the adcp data file id and
# directory subfolder to store the csv table files
